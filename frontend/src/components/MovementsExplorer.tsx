...
import type { GenreDetail, GenreSummary } from "@/types/genre";

export function MovementsExplorer({ genres }: { genres: GenreSummary[] }) {
        ...
        <aside className="map-side">
          {!selected && (
            <>
              ...
              <p className="lede">Try Afro Jazz, Bubblegum, Kwaito, Amapiano, or Lekompo.</p>
            </>
          )}
          {selected && (
            <>
